...
public class SpliceBranchAnalysis {
	...
	//			for (String motif : BRANCH_POINT_SEQUENCES) {
	...
	//	public static int SIZE_CONSENSUS_DONOR = 6;
	//	public static int SIZE_CONSENSUS_ACCEPTOR = 3;
	...
	//
	//	public static String[] BRANCH_POINT_SEQUENCES = { "TCCTTAAC", "TCCTTGAC", "TCCTTAAT", "TCCTTGAT" // U12 consensus, from "Evolutionary Fates and Origins of U12 
	//			, "TACTAAC" // From Yeast
	...
	//	String genomeFasta;
	//	StringBuilder out = new StringBuilder();
	//	StringBuilder spliceSeqs = new StringBuilder();
	//	Config config;
	//	HashMap<String, PwmSet> pwms;
	//	RnaStackedFreeEnergy rnaFreeEnergy;
	//	CountByType countConsensus = new CountByType();
	//
	//	/**
	//	 * Main
	//	 * @param args
	...
	//
	//		String outputSpliceFile = OUTPUT_DIR + "/" + this.getClass().getSimpleName() + "_" + genomeVer + ".txt";
	//		Timer.showStdErr("Saving splice sequences to: " + outputSpliceFile);
	//		Gpr.toFile(outputSpliceFile, spliceSeqs);
	//	}
	//
	//	/**
	...
	//		out("</table>\n");
	//
	//		out("<p><b>Count consensus:</b><p>\n<pre>");
	//		out(countConsensus.toStringSort());
	//		out("\n</pre>");
	//	}
	//
	//	/**
	...
	//		spliceSeqs.append(intronSeqDonor + "\t" + branchStr + "\t" + intronSeqAcc + "\n");
	//
	//		if (debug) {
	...
	//		pwmSet.bestFreeEergy(intronSeqDonor, branchStr);
	//		pwmSet.len(len);
	//
	//		// Update total counts
